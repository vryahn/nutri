...
const EN = {
  ...
  'Bandas simétricas alrededor de tu objetivo.': 'Symmetric bands around your target.',
  Entreno: 'Training',
  'Entreno largo': 'Long training',
  Descanso: 'Rest',
  'Configuración guardada': 'Setup saved',
  'Tu fase y fechas especiales ya están en Metas.': 'Your phase and special dates are now in Targets.',
  'Cada tipo de día necesita kcal mayores a 0.': 'Each day type needs kcal greater than 0.',
  'Elige una fecha de inicio válida.': 'Pick a valid start date.',
  Comenzar: 'Start',
  Atrás: 'Back',
  Siguiente: 'Next',
  'Guardar configuración': 'Save setup',
  '¿Sobrescribir lo existente?': 'Overwrite existing?',
  'Ya hay una fase que aplica desde el %n; se reemplazará.': 'A phase already applies from %n; it will be replaced.',
  '%n fecha(s) especial(es) ya existen y se reemplazarán.': '%n special date(s) already exist and will be replaced.',
  'Sobrescribir y guardar': 'Overwrite and save',
  'Configura tus metas paso a paso': 'Set up your targets step by step',
  'Te guiaré para crear una fase: régimen, patrón semanal (entreno / descanso), kcal y macros por tipo de día, agua y electrolitos, y fechas especiales.':
    'I\'ll guide you through creating a phase: regimen, weekly pattern (training / rest), kcal and macros per day type, water and electrolytes, and special dates.',
  'Fases existentes': 'Existing phases',
  vigente: 'active',
  programada: 'scheduled',
  'Escribir una fase en una fecha ya ocupada la sobrescribe.': 'Writing a phase on an already-used date overwrites it.',
  Régimen: 'Regimen',
  'Tus márgenes de cumplimiento se ajustan solos a este régimen.': 'Your adherence margins adjust automatically to this regimen.',
  'Toca cada día para asignarlo a un tipo. Un tipo sin días se descarta.': 'Tap each day to assign it to a type. A type with no days is discarded.',
  'Tipos de día': 'Day types',
  'Tipo de día': 'Day type',
  'Nombre del tipo de día': 'Day type name',
  'Referencia de proteína: 1.6–2.7 g por kg de peso corporal.': 'Protein reference: 1.6–2.7 g per kg of body weight.',
  'Se aplican a todos los tipos de día. Valores de referencia — ajústalos a tu plan.':
    'Applied to all day types. Reference values — adjust them to your plan.',
  'Agua (ml)': 'Water (ml)',
  'Potasio (mg)': 'Potassium (mg)',
  'Magnesio (mg)': 'Magnesium (mg)',
  'Sodio: piso médico %f mg y techo %c mg, fijos en la app.': 'Sodium: medical floor %f mg and ceiling %c mg, fixed in the app.',
  'Máximos a no rebasar. Opcionales: déjalos vacíos si no los usas.': 'Maximums not to exceed. Optional: leave them empty if unused.',
  'Grasa sat. (g)': 'Sat. fat (g)',
  'Az. añadido (g)': 'Added sugar (g)',
  'Alcohol (g)': 'Alcohol (g)',
  'Az. añadido': 'Added sugar',
  'Omitir (dejar sin techos)': 'Skip (no ceilings)',
  'Días que sustituyen a la fase (cumpleaños, día pico…). Opcional.': 'Days that replace the phase (birthday, peak day…). Optional.',
  'Añadir fecha especial': 'Add special date',
  'Sobrescribe la fase existente de esa fecha.': 'Overwrites the existing phase for that date.',
